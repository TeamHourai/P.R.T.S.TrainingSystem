/**
 * PRTS 公共组件：模态框 & 轻提示 (window.uiModal / window.PRTSModal)
 * ------------------------------------------------------------------
 * 统一替代原生 alert()/confirm()，提供一致的交互与样式。
 * 同时挂载到 window.PRTSModal 以纳入统一命名空间。
 *
 * 用法：
 *   uiModal.info('...')
 *   uiModal.success('...')
...
(function () {
    ...
    window.uiModal = modalApi;
    window.PRTSModal = modalApi;
})();
