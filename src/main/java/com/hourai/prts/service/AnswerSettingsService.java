...
public class AnswerSettingsService {
    ...
    public AnswerSettings getForUser(long userId) throws SQLException {
        return dao.selectByUserId(userId);
    }

    public AnswerSettings upsert(long userId, boolean autoSubmit, boolean autoNextCorrect) throws SQLException {
